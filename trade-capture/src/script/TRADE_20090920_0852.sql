...
CREATE TABLE  `trade`.`Marca` (
  ...
  PRIMARY KEY  (`idMarca`)
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=latin1 COMMENT='Tabla con las descripciones de las marcas';
...
INSERT INTO `trade`.`Producto` VALUES  ('681131698504','Mostaza',49.00,0.00,1,3,3.78,2,'Bakers & Chefs',5,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501003124272','Garbanzos',9.00,0.00,1,3,400.00,1,'Herdez',30,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501003340146','Mayonesa',37.50,0.00,1,3,790.00,1,'McCormick',43,NULL,NULL),
 ...
 ('7501017004270','Frijoles Bayos Refritos',13.00,0.00,1,3,580.00,1,'La Costeña',34,NULL,NULL);
INSERT INTO `trade`.`Producto` VALUES  ('7501017004423','Frijoles negros refritos',13.00,0.00,1,3,580.00,1,'La Costeña',34,NULL,NULL),
 ...
 ('7501017050215','Mayonesa',12.00,0.00,1,3,190.00,1,'La Costeña',34,NULL,NULL);
INSERT INTO `trade`.`Producto` VALUES  ('7501018203849','Catsup',15.00,0.00,1,3,1.00,2,'Embasa',23,NULL,NULL),
 ...
 ('7501023602057','Atún en aceite',95.00,0.00,1,3,1.35,2,'NAIR',46,NULL,NULL);
INSERT INTO `trade`.`Producto` VALUES  ('7501023602064','Atun en agua',95.00,0.00,1,3,1.35,2,'NAIR',46,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501072400154','Aceitunas',8.50,0.00,1,3,36.00,1,'California Stars',11,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501728027032','Pimiento Morron',8.50,0.00,1,3,185.00,1,'Don Agustin',19,NULL,NULL),
