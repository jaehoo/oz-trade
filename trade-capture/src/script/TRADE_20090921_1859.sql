...
--
-- Definition of table `trade`.`Categoria`
--

DROP TABLE IF EXISTS `trade`.`Categoria`;
CREATE TABLE  `trade`.`Categoria` (
...
--
-- Dumping data for table `trade`.`Categoria`
--

/*!40000 ALTER TABLE `Categoria` DISABLE KEYS */;
LOCK TABLES `Categoria` WRITE;
INSERT INTO `trade`.`Categoria` VALUES  (1,'Quesos'),
 (2,'Carnes Frias'),
...
--
-- Definition of table `trade`.`DetalleInventario`
--

DROP TABLE IF EXISTS `trade`.`DetalleInventario`;
CREATE TABLE  `trade`.`DetalleInventario` (
  `idDetalleInventario` bigint(20) NOT NULL auto_increment,
  `idProducto` varchar(150) NOT NULL,
  `costoUnitario` double NOT NULL default '0',
  `cantidad` int(10) NOT NULL default '0',
  `cantidadTotal` int(10) default '0',
  `fechaRegistro` datetime NOT NULL,
  `fechaModificacion` datetime NOT NULL,
  `tipoRegistro` tinyint(1) NOT NULL default '0',
  PRIMARY KEY  (`idDetalleInventario`),
  KEY `fk_DetalleInventario_Producto` (`idProducto`),
  CONSTRAINT `fk_DetalleInventario_Producto` FOREIGN KEY (`idProducto`) REFERENCES `Producto` (`idProducto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `trade`.`DetalleInventario`
--
...
--
-- Definition of table `trade`.`Grupo`
--

DROP TABLE IF EXISTS `trade`.`Grupo`;
CREATE TABLE  `trade`.`Grupo` (
...
--
-- Dumping data for table `trade`.`Grupo`
--

/*!40000 ALTER TABLE `Grupo` DISABLE KEYS */;
LOCK TABLES `Grupo` WRITE;
INSERT INTO `trade`.`Grupo` VALUES  (0,'NA','N/A');
UNLOCK TABLES;
...
INSERT INTO `trade`.`Producto` VALUES  ('027000384954','Salsa Barbecue',16.00,1,3,0,612.00,1,32,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('605388002327','Catsup',42.30,1,3,0,3.80,2,5,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501000101078','Pan integral 100%',22.00,1,3,0,680.00,1,81,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501000139699','Pan Integral 100% ajonjolí',24.00,1,3,0,680.00,1,81,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501001604318','Salsa inglesa',17.50,1,3,0,145.00,4,79,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501003336422','Mermelada Naranja',12.00,1,3,0,270.00,1,43,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501011909281','Chiles Chipotles',19.50,1,3,0,380.00,1,25,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501017041053','Frijoles Negros Enteros',8.50,1,3,0,425.00,1,34,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501023602057','Atún en aceite',95.00,1,3,0,1.35,2,46,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501032339517','Yoghurt fresa',4.00,1,3,0,250.00,1,15,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501040003660','Salchicha Viena',30.00,1,2,0,0.00,2,85,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501040820069','Caja amarillo',79.20,1,1,0,1.80,2,68,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501052476032','Chiles jalapeños en rajas',49.00,1,3,0,2.80,2,14,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501055309658','CocaCola mini',4.00,1,3,0,237.00,4,87,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501055901111','Yoghurt con durazno',4.00,1,3,0,150.00,1,3,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7501083100012','Vinagre obscuro',7.50,1,3,0,750.00,4,6,NULL,NULL),
...
INSERT INTO `trade`.`Producto` VALUES  ('7502209170582','Tocino aumado',52.00,1,2,0,0.00,2,76,NULL,NULL),
...
--
-- Definition of table `trade`.`UnidadMedida`
--

DROP TABLE IF EXISTS `trade`.`UnidadMedida`;
CREATE TABLE  `trade`.`UnidadMedida` (
...
--
-- Dumping data for table `trade`.`UnidadMedida`
--

/*!40000 ALTER TABLE `UnidadMedida` DISABLE KEYS */;
LOCK TABLES `UnidadMedida` WRITE;
INSERT INTO `trade`.`UnidadMedida` VALUES  (1,'gr','Gramos'),
 (2,'kg','Kilos'),
 (3,'Lt','Litros'),
 (4,'ml','Mililitros'),
 (5,'Pza','Piezas'),
